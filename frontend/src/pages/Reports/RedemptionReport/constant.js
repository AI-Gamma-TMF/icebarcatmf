...
export const NewYAxisOptions = [
  { label: 'All', value: 'all' },

  // Revenue-related
  { label: 'Revenue', value: 'revenue', color: '#4caf50' },
  { label: 'Total Revenue', value: 'totalRevenue', color: '#81c784' },

  // Redemption-related
  { label: 'Redemptions', value: 'redemptions', color: '#2196f3' },
  { label: 'Pending Redemptions', value: 'pendingRedemptions', color: '#03a9f4' },
  { label: 'In-Progress Redemptions', value: 'inProcessRedemptions', color: '#0288d1' },
  { label: 'Total Redemptions', value: 'totalRedemptions', color: '#1976d2' },
  { label: 'Total Pending Redemptions', value: 'totalPendingRedemptions', color: '#1565c0' },
  { label: 'Total In-Progress Redemptions', value: 'totalInprocessRedemptions', color: '#0d47a1' },

  // Rate-related
  { label: 'Redemptions Rate', value: 'redemptionsRate', color: '#ff9800' },
  { label: 'Lifetime Redemptions Rate', value: 'lifetimeRedemptionsRate', color: '#f44336' },
]
