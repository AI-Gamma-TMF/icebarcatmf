...
const BonusInfoPopup = ({ bonusGraphData, selectedMetric, setShowInfoBox }) => {
    ...
    return (
        <div style={{
            ...
            <ul>
                {bonusGraphData.datasets.map(ds => (
                    <li key={ds.label}><span style={{ color: ds.borderColor }}>{ds.label}</span></li>
                ))}
            </ul>
            <p><strong>Total Bonus Types:</strong> {bonusGraphData.datasets.length}</p>
