...
module.exports = (sequelize, DataTypes) => {
  ...
  UserBonus.associate = function (models) {
    ...
    UserBonus.belongsTo(models.PromotionCode, { foreignKey: 'promocodeId' })
    UserBonus.belongsTo(models.Tier, { foreignKey: 'tierId' })
    UserBonus.hasOne(models.ScratchCards, { foreignKey: 'scratchCardId', sourceKey: 'scratchCardId', as: 'scratchCard' })
    UserBonus.hasMany(models.TransactionBanking, { foreignKey: 'userBonusId' })
    UserBonus.belongsTo(models.FreeSpinBonusGrant, { foreignKey: 'freeSpinId' })
  }
